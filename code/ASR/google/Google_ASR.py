...
def google_asr(audio, filename):
    ...
    with open('C:/Users/73936/Desktop/voice_speech/zeta-treat-269903.json', "r") as f:
        credentials = f.read()
    # GOOGLE_CLOUD_SPEECH_CREDENTIALS = C:/github_code/audio_tsm_test/qhjiang/zeta-treat-269903.json'
    try:
        print("Google Cloud Speech thinks you said " + r.recognize_google_cloud(audio, credentials_json=credentials))
        with open(filename, 'a') as file_object:
            file_object.write( r.recognize_google_cloud(audio, credentials_json=credentials)+ '\n')
    except sr.UnknownValueError:
...
for num in range(0, 10):
    ...
    for i in np.arange(0.25, 3.0, 0.25):
        ...
        # google_asr_origin = 'C:/github_code/audio_tsm_test/test_result/google_origin.txt'
        google_asr_phasevoctor = 'C:/github_code/audio_tsm_test/test_result/google/google_asr_phasevoctor' + str(i) + '.txt'
        google_asr_ola = 'C:/github_code/audio_tsm_test/test_result/google/google_asr_ola' + str(i) + '.txt'
        google_asr_wsola = 'C:/github_code/audio_tsm_test/test_result/google/google_asr_wsola' + str(i) + '.txt'
        ...
        #     audio = r.record(source)
        #     print(audio)
        #     google_asr(audio, google_asr_ola)
        #     # google_asr(audio, google_asr_phasevoctor)
        # with sr.AudioFile(audio_wsola) as source:
        #     audio = r.record(source)
        #     print(audio)
        #     google_asr(audio, google_asr_wsola)
        #     # google_asr(audio, google_asr_phasevoctor)
