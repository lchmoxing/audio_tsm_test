...
if __name__ == '__main__':
    ...
    gen = 1
    path1 = r"/home/usslab/qinhong/deepspeech/audio/speech_split/de1_test"
    ...
    position_random = np.random.randint(0, split_frame_num, size = pop_max)
    speed_random =  np.random.randint(speed_min, speed_max, size = pop_max)
