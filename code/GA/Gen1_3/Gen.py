...
#         #初始化速度
#         split_length = len(os.listdir(path1))
#         perturb_speed = np.random.randint(5, 20, (split_length, 1))
#         gen = 1
#         pop = 1
#         # print(perturb_speed)
#         #perturb_speed = tf.random.uniform([split_length],minval=5, maxval=20, dtype=tf.int32)
#         # with tf.Session() as sess:
#         #     print(sess.run(perturb_speed))
#         # with tf.Session() as sess:
#         #     print(sess.run(tf.size(perturb_speed)))
#         for i in range(np.size(perturb_speed)):
#             tsm_in_path = path1 + '/' + str(i+1) + '.wav'
#             tsm_out_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/tsm2/" + str(i+1) + '.wav'
#             v = perturb_speed[i] / 10
#             audio_tsm(ola, v, tsm_in_path, tsm_out_path)
#         join_input_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/tsm2"
#         join_output_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/outputlee/" + str(gen) + '_' + str(pop) + '.wav'
...
#                 file_object.write(str(gen) + '_' + str(pop) + ':' + hypothesis + '\n')
#         score = Levenshtein_similarity(hypothesis, 'picture')
#         print(score)
#target = 'nature'

#Create initial generation#
def pop_initial(pop_max):
    gen = 1
    path1 = r"/home/usslab/qinhong/deepspeech/audio/speech_split/picture"
    ...
    for i in range(pop_max):
        for j in range(split_frame_num):
            tsm_in_path = path1 + '/' + str(j + 1) + '.wav'
            tsm_out_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/tsm2/" + str(j + 1) + '.wav'
            v = perturb_speed[i][j] / 10
            audio_tsm(ola, v, tsm_in_path, tsm_out_path)
        join_input_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/tsm2"
        join_output_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/outputlee/" + str(gen) + '_' + str(i + 1) + '.wav'
        audio_join(join_input_path, join_output_path)
        hypothesis.append(asr_deepspeech(join_output_path))
    print(hypothesis)
