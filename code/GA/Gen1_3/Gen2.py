...
if __name__ == '__main__':
    ...
    for i in range(pop_max):
        ...
        join_output_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/outputlee/" + str(gen) + '_' + str(
            i + 1) + '.wav'
...
#     while gen < gen_max:
# # softmax处理#
#         softmax_fitness_score = softmax(fitness_score)
#         print(softmax_fitness_score)
#         gen = gen + 1
#crossover孩子交叉#
