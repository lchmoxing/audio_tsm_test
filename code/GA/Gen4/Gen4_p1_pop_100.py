...
if __name__ == '__main__':
    ...
    hypothesis = []
    fitness_score = []
    filename = r"/home/usslab/qinhong/deepspeech/audio/speech_split/output_p1_100/result_p1_100.txt"
    ...
    for i in range(pop_max):
        for j in range(split_frame_num):
            ...
            tsm_out_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/tsm_p1_100/" + str(j + 1) + '.wav'
            v = perturb_speed[i][j] / 10
            audio_tsm(ola, v, tsm_in_path, tsm_out_path)
        join_input_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/tsm_p1_100"
        join_output_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/output_p1_100/" + str(gen) + '_' + str(
            i + 1) + '.wav'
