...
if __name__ == '__main__':
    ...
    gen = 1
    path1 = r"/home/usslab/qinhong/deepspeech/audio/speech_split/picture_1"
    ...
    hypothesis = []
    fitness_score = []
    filename = r"/home/usslab/qinhong/deepspeech/audio/speech_split/output_p1_100_p/result_p1_100_p.txt"
    ...
    for i in range(pop_max):
        for j in range(split_frame_num):
            ...
            tsm_out_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/tsm_p1_100_p/" + str(j + 1) + '.wav'
            v = perturb_speed[i][j] / 10
            audio_tsm(ola, v, tsm_in_path, tsm_out_path)
        join_input_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/tsm_p1_100_p"
        join_output_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/output_p1_100_p/" + str(gen) + '_' + str(
            i + 1) + '.wav'
