...
if __name__ == '__main__':
    ...
    gen = 1
    path1 = r"/home/usslab/qinhong/deepspeech/audio/speech_split/picture_2"
    ...
    hypothesis = []
    fitness_score = []
    filename = r"/home/usslab/qinhong/deepspeech/audio/speech_split/output_p2/result_p2.txt"
    ...
    for i in range(pop_max):
        for j in range(split_frame_num):
            tsm_in_path = path1 + '/' + "2_{}.wav".format(str(j+1))
            tsm_out_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/tsm_p2/" + str(j + 1) + '.wav'
            v = perturb_speed[i][j] / 10
            audio_tsm(ola, v, tsm_in_path, tsm_out_path)
        join_input_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/tsm_p2"
        join_output_path = r"/home/usslab/qinhong/deepspeech/audio/speech_split/output_p2/" + str(gen) + '_' + str(
            i + 1) + '.wav'
        ...
        if result_tmp != '':
            with open(filename, 'a') as file_object:
                file_object.write(str(gen) + '_' + str(i) + ':' + result_tmp + '\n')
