...
filename = "C:/Users/73936/Desktop/voice_speech/database/text2.txt"
num = 100
...
with open(filename,'r', encoding='UTF-8') as text_object:
    for text in text_object:
        ...
        filename_mp3 = 'C:/Users/73936/Desktop/voice_speech/database/' + str(num) +'.mp3'
        filename_wav = 'C:/Users/73936/Desktop/voice_speech/database/' + str(num) +'.wav'
